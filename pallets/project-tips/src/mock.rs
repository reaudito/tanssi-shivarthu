...
pub fn new_test_ext() -> sp_io::TestExternalities {
	let mut t: sp_runtime::Storage = frame_system::GenesisConfig::<Test>::default().build_storage().unwrap();
	...
	.unwrap();
	pallet_shared_storage::GenesisConfig::<Test> { approved_citizen_address: vec![1, 2] }
		.assimilate_storage(&mut t)
		.unwrap();
	t.into()
}
